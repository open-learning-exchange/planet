...
LATEST_APK_VERSION="v0.6.88"
LATEST_APK_VER_CODE="688"
MIN_APK_VERSION="v0.6.88"
MIN_APK_VER_CODE="688"
APK_PATH="https://github.com/open-learning-exchange/myplanet/releases/download/v0.6.88/myPlanet.apk"
