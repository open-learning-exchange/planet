...
LATEST_APK_VERSION="v0.5.44"
LATEST_APK_VER_CODE="544"
MIN_APK_VERSION="v0.5.34"
MIN_APK_VER_CODE="534"
APK_PATH="https://github.com/open-learning-exchange/myplanet/releases/download/v0.5.44/myPlanet.apk"
