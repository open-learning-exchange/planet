...
LATEST_APK_VERSION="v0.2.92"
LATEST_APK_VER_CODE="292"
MIN_APK_VERSION="v0.2.92"
MIN_APK_VER_CODE="292"
APK_PATH="https://github.com/open-learning-exchange/myplanet/releases/download/v0.2.92/myPlanet.apk"
