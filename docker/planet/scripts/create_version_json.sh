...
LATEST_APK_VERSION="v0.6.85"
LATEST_APK_VER_CODE="685"
MIN_APK_VERSION="v0.6.85"
MIN_APK_VER_CODE="685"
APK_PATH="https://github.com/open-learning-exchange/myplanet/releases/download/v0.6.85/myPlanet.apk"
