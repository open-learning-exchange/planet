...
LATEST_APK_VERSION="v0.2.81"
LATEST_APK_VER_CODE="281"
MIN_APK_VERSION="v0.2.81"
MIN_APK_VER_CODE="281"
APK_PATH="https://github.com/open-learning-exchange/myplanet/releases/download/v0.2.81/myPlanet.apk"
