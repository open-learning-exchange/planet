...
LATEST_APK_VERSION="v0.7.22"
LATEST_APK_VER_CODE="722"
MIN_APK_VERSION="v0.7.22"
MIN_APK_VER_CODE="722"
APK_PATH="https://github.com/open-learning-exchange/myplanet/releases/download/v0.7.22/myPlanet.apk"
