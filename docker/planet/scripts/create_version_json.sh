...
LATEST_APK_VERSION="v0.5.34"
LATEST_APK_VER_CODE="534"
MIN_APK_VERSION="v0.5.27"
MIN_APK_VER_CODE="527"
APK_PATH="https://github.com/open-learning-exchange/myplanet/releases/download/v0.5.34/myPlanet.apk"
