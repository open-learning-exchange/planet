...
@Component({
  template: `
    ...
    <mat-dialog-actions>
      <button color="primary" *ngIf="editable" routerLink="/users/profile/{{usersProfileComponent.urlName}}" mat-raised-button mat-dialog-close i18n>View full profile</button>
