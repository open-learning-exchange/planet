import { Component, Input, ElementRef, ViewChild, Output, EventEmitter, AfterViewChecked, ChangeDetectorRef, HostBinding, HostListener, OnInit, forwardRef } from '@angular/core';
...
@Component({
    ...
    imports: [MatCard, NgIf, RouterLink, forwardRef(() => DashboardTileTitleComponent), MatIcon, CdkDropList, NgClass, NgFor, AuthorizedRolesDirective, CdkDrag, MatTooltip, MatBadge, NgStyle, MatIconButton, PlanetLoadingSpinnerComponent, TruncateTextPipe]
})
