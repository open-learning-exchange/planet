...
export abstract class MyPlanetFiltersBase {
  ...
  private updateFormValidators() {
    this.filtersForm.get('startDate')?.setValidators([ Validators.required, Validators.min(this.minDate.getTime()), Validators.max(this.today.getTime()) ]);
    this.filtersForm.get('endDate')?.setValidators([ Validators.required, Validators.min(this.minDate.getTime()), Validators.max(this.today.getTime()) ]);
