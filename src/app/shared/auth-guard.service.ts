...
import { AuthService as PouchAuthService } from './services';

@Injectable()
export class AuthService {

  constructor(private authService: PouchAuthService, private couchService: CouchService, private userService: UserService,
