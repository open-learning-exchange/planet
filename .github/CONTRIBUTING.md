...
You can get an overview of Planet Learning in the [Planet User Manual](https://open-learning-exchange.github.io/#!pages/manual/planet/overview.md).

# Our Development Cycle/On-Boarding

OLE software is built using JavaScript, CouchDB, Angular

OLE maintains an on-boarding exercise for virtual interns that provides a foundation in both our software and our workflow on GitHub. Start with the [Virtual Intern first steps](https://open-learning-exchange.github.io/#!pages/vi/vi-first-steps.md).
...
* [Planet](https://github.com/open-learning-exchange/planet) - Planet Learning written in TypeScript and Angular
